...
static int __init non_blockIO_init(void)
{
    int ret, irq;
...
static void __exit non_blockIO_exit(void)
{
    gpio_free(PIN_NUM);
...
module_init(non_blockIO_init);
module_exit(non_blockIO_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("1477153217@qq.com");
MODULE_DESCRIPTION("non-block IO test");
